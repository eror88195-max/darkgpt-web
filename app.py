...
<div class="sidebar">
    ...
    <div class="footer-side"><span><i class="fas fa-shield-alt"></i> خصوصية</span><span>v1.5</span></div>
</div>
<div class="main">
    <div class="hero">
...
def ask():
    try:
        ...
        # تم التعديل هنا لاستخدام اسم النموذج القياسي المعتمد في واجهة البرمجة
