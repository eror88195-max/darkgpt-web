...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', system-ui, sans-serif; }
        ...
        /* ===== الشريط الجانبي (يختفي في الجوال) ===== */
        ...
        /* ===== المنطقة الرئيسية (تاخذ باقي العرض) ===== */
        .main { flex: 1; display: flex; flex-direction: column; height: 100vh; background: #0e0e16; overflow: hidden; }

        /* ===== الهيرو (صورة العرض + الأنيميشن) ===== */
        .hero {
            background: radial-gradient(ellipse at center, #1a0f2a, #0b0b12 70%);
        ...
        @keyframes floatGlow {
            0% { transform: translateY(0px) scale(1); text-shadow: 0 0 20px #9c27b0; }
            50% { transform: translateY(-12px) scale(1.05); text-shadow: 0 0 40px #b388ff, 0 0 80px #7b1fa2; }
            100% { transform: translateY(0px) scale(1); text-shadow: 0 0 20px #9c27b0; }
        }

        /* ===== زر المحادثة الجديدة (الرئيسي) ===== */
        .new-chat-main {
            display: flex;
        ...
        /* ===== منطقة المحادثة (تملأ باقي المساحة) ===== */
        .chat-area {
            flex: 1;
            overflow-y: auto;
        ...
        /* ===== تحسينات التجاوب التلقائي (لجميع الأجهزة) ===== */
        @media (max-width: 768px) {
            .sidebar { display: none; }
            .main { width: 100%; }
            .hero { padding: 20px 15px 10px 15px; }
            .hero .robot-glow { font-size: 52px; }
            .hero h1 { font-size: 22px; }
            .hero .sub { font-size: 12px; }
            .message { max-width: 92%; font-size: 14px; padding: 12px 16px; }
            .features-bar { gap: 12px; }
            .features-bar .feature-item { font-size: 11px; }
            .features-bar .feature-item i { font-size: 16px; width: 22px; }
            .input-area { padding: 10px 12px 12px 12px; }
            .input-area .input-wrapper input { font-size: 14px; padding: 10px 8px; }
            .input-area .input-wrapper .robot-icon { width: 42px; height: 42px; font-size: 18px; }
            .new-chat-main button { padding: 10px 20px; font-size: 14px; }
        }

        @media (max-width: 480px) {
            .hero .robot-glow { font-size: 42px; }
            .hero h1 { font-size: 20px; }
            .message { font-size: 13px; padding: 10px 14px; }
            .features-bar .feature-item { font-size: 10px; gap: 6px; }
            .features-bar .feature-item i { font-size: 14px; width: 20px; }
            .input-area .input-wrapper input { font-size: 13px; padding: 8px 6px; }
            .input-area .input-wrapper .robot-icon { width: 38px; height: 38px; font-size: 16px; }
            .new-chat-main button { padding: 8px 16px; font-size: 13px; }
        }

        /* سكرول أنيق */
        ::-webkit-scrollbar { width: 6px; }
        ::-webkit-scrollbar-track { background: #0e0e16; }
        ::-webkit-scrollbar-thumb { background: #2a1f3a; border-radius: 10px; }
        ::-webkit-scrollbar-thumb:hover { background: #3b2a52; }
    </style>
</head>
<body>
